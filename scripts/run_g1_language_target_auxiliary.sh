...
SOURCE_CHECKPOINT="${SOURCE_CHECKPOINT:-$PROJECT_ROOT/outputs/G1LANG-26_film_adapter_29000step/checkpoints/029000/pretrained_model}"
OUTPUT_DIR="${OUTPUT_DIR:-$PROJECT_ROOT/outputs/G1LANG-27_target_auxiliary_30000step}"
LOG_PATH="${LOG_PATH:-$PROJECT_ROOT/outputs/G1LANG-27_target_auxiliary.log}"
...
echo "G1_LANGUAGE_TARGET_AUXILIARY_COMPLETE=1"
