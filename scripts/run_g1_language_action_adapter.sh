...
SOURCE_CHECKPOINT="${SOURCE_CHECKPOINT:-$PROJECT_ROOT/outputs/G1LANG-20_vlm_layer_curriculum_24000step/checkpoints/024000/pretrained_model}"
OUTPUT_DIR="${OUTPUT_DIR:-$PROJECT_ROOT/outputs/G1LANG-22_language_action_adapter_25000step}"
LOG_PATH="${LOG_PATH:-$PROJECT_ROOT/outputs/G1LANG-22_language_action_adapter.log}"
...
echo "G1_LANGUAGE_ACTION_ADAPTER_COMPLETE=1"
