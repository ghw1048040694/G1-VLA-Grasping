...
OUTPUT_DIR="$PROJECT_ROOT/outputs/G1UB-03_Genesis_scale_after_reboot"
...
for num_envs in "${ENV_COUNTS[@]}"; do
  ...
  echo "Starting 10-iteration Genesis scale probe: num_envs=$num_envs"
  (
    cd "$ASAP_ROOT"
    ...
    "$PYTHON" humanoidverse/train_agent.py \
      ...
      project_name=G1UB-03 \
      experiment_name="scale_${num_envs}" \
