...
CHECKPOINT="${CHECKPOINT:-$PROJECT_ROOT/outputs/G1LANG-33_scene_action_decoder_39000step/checkpoints/039000/pretrained_model}"
GATE_ROOT="${GATE_ROOT:-$PROJECT_ROOT/outputs/G1LANG-33_scene_action_gate_039000}"
LOG_PATH="${LOG_PATH:-$PROJECT_ROOT/outputs/G1LANG-33_scene_action_gate.log}"
...
echo "G1_LANGUAGE_SCENE_ACTION_GATE_COMPLETE=1"
