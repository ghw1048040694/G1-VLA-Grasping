...
OUTPUT_DIR="$PROJECT_ROOT/outputs/G1UB-01B_Genesis_capacity_audit"
...
for num_envs in "${ENV_COUNTS[@]}"; do
  ...
  echo "Starting Genesis capacity probe: num_envs=$num_envs"
  (
    cd "$ASAP_ROOT"
