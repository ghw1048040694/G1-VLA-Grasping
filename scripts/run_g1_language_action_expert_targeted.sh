...
SOURCE_CHECKPOINT="${SOURCE_CHECKPOINT:-$PROJECT_ROOT/outputs/G1LANG-29_target_bilinear_32000step/checkpoints/032000/pretrained_model}"
OUTPUT_DIR="${OUTPUT_DIR:-$PROJECT_ROOT/outputs/G1LANG-30_action_expert_targeted_33000step}"
LOG_PATH="${LOG_PATH:-$PROJECT_ROOT/outputs/G1LANG-30_action_expert_targeted.log}"
...
echo "G1_LANGUAGE_ACTION_EXPERT_TARGETED_COMPLETE=1"
