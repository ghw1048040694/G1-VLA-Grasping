...
SOURCE_CHECKPOINT="${SOURCE_CHECKPOINT:-$PROJECT_ROOT/outputs/G1LANG-24_vlm_action_adapter_27000step/checkpoints/027000/pretrained_model}"
OUTPUT_DIR="${OUTPUT_DIR:-$PROJECT_ROOT/outputs/G1LANG-25_direct_action_head_28000step}"
LOG_PATH="${LOG_PATH:-$PROJECT_ROOT/outputs/G1LANG-25_direct_action_head.log}"
...
echo "G1_LANGUAGE_DIRECT_ACTION_HEAD_COMPLETE=1"
