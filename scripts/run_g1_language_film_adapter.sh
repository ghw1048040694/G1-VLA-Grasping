...
SOURCE_CHECKPOINT="${SOURCE_CHECKPOINT:-$PROJECT_ROOT/outputs/G1LANG-25_direct_action_head_28000step/checkpoints/028000/pretrained_model}"
OUTPUT_DIR="${OUTPUT_DIR:-$PROJECT_ROOT/outputs/G1LANG-26_film_adapter_29000step}"
LOG_PATH="${LOG_PATH:-$PROJECT_ROOT/outputs/G1LANG-26_film_adapter.log}"
...
echo "G1_LANGUAGE_FILM_ADAPTER_COMPLETE=1"
