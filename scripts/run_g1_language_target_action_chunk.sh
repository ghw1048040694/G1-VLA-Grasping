...
SOURCE_CHECKPOINT="${SOURCE_CHECKPOINT:-$PROJECT_ROOT/outputs/G1LANG-27_target_auxiliary_30000step/checkpoints/030000/pretrained_model}"
OUTPUT_DIR="${OUTPUT_DIR:-$PROJECT_ROOT/outputs/G1LANG-28_target_action_chunk_31000step}"
LOG_PATH="${LOG_PATH:-$PROJECT_ROOT/outputs/G1LANG-28_target_action_chunk.log}"
...
echo "G1_LANGUAGE_TARGET_ACTION_CHUNK_COMPLETE=1"
