...
SOURCE_CHECKPOINT="${SOURCE_CHECKPOINT:-$PROJECT_ROOT/outputs/G1LANG-22_language_action_adapter_25000step/checkpoints/025000/pretrained_model}"
OUTPUT_DIR="${OUTPUT_DIR:-$PROJECT_ROOT/outputs/G1LANG-23_action_expert_adapter_26000step}"
LOG_PATH="${LOG_PATH:-$PROJECT_ROOT/outputs/G1LANG-23_action_expert_adapter.log}"
...
echo "G1_LANGUAGE_ACTION_EXPERT_ADAPTER_COMPLETE=1"
